...
한계(실측, eval_out/ 참고): 서로 비슷하게 생긴 소형 기계부품(bearing/bolt/gear/nut,
mechanical-parts test 204장) 기준 정밀도 0.22~0.29 로, 무검수 초기 라벨셋 기준
(학습모델 오토라벨 P 0.87~0.90)에 크게 미달. NMS·거대박스 제거·임계값 상향으로도
