...
EXPS = [
    ...
    {"id": "c36_syn2121", "label": "36클래스 · 합성 2121(부품당 59) · 배경 417",
     ...
     "models": ["yolo11n", "yolo11s", "yolo11m", "yolo26s"]},
    {"id": "c36_panel400", "label": "36클래스 · 합성 14127(부품당 392·판넬 가림) · 배경 984 · mixup+erasing",
     "classes": 36, "synth": 14127, "bg": 984, "train": 22751,
     "base": "results/bench/260821_panel400/{m}/weights/best.pt",
     "models": ["yolo11n", "yolo11s", "yolo11m", "yolo26n", "yolo26s", "yolo26m", "yolov8s", "yolov8m"]},
    {"id": "c36_3x", "label": "36클래스 · 합성 26820(실촬 비례 3배·판넬 가림) · 배경 567(사무실 제외)",
     "classes": 36, "synth": 26820, "bg": 567, "train": 36470,
     "base": "results/bench/260824_retrain3x/{m}/weights/best.pt",
     "models": ["yolo11m", "yolo11s", "yolo11n", "yolo26m", "yolo26s", "yolo26n", "yolov8m", "yolov8s"]},
