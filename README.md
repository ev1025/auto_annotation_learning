...
설계 변경 이력(무엇이 어떻게 바뀌었는지)은 [CHANGELOG.md](CHANGELOG.md)에 계속 기록한다.
...
주: [1][3][4][6]의 합성(렌더) 학습 부분은 렌더 학습 경로 폐기(CHANGELOG 2026-07-22)로 참고 가치가 낮아짐. 파인튜닝 레시피·증강 등 실사 적용 기법은 유효.
