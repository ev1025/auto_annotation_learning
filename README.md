...
7모델(v8n/s/m·11n·26n/s/m) × 입력 2크기(640/1280) = 14조합을 동일 조건(epochs 100, 동일 test 분할, RTX 5090)으로 비교. 전체 표는 `results/benchmark/benchmark.md`, 실행 방법은 6.5.
...
**후속 검증 3종** (`results/benchmark/exp_epochs.json`)
